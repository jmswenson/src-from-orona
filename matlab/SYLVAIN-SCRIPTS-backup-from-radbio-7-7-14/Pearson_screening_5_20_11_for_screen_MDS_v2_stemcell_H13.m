...
target_dir = '/mnt/orona/jswenson/InCell6000/test-small/';
output_dir = '/mnt/orona/jswenson/InCell6000/test-small/';
...
blurr_rad = 150; % the larger, the milder the background correction: 30 for the screen, 60 (or 30) for the 60X DV, for cytopsin 90, for live HP1a 150
...
nuc_rad = 20; %use 8 for the screen  %use 20 when using the DV 60X with Kc cells, 25 for S2, for live HP1a 40X use 10, for live HP1a 60X use 20
