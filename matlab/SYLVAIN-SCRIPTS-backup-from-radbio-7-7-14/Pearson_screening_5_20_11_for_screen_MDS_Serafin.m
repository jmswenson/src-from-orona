...
target_dir = '/mnt/orona/ShareWithGenuser/Joel-live-test-12-15-12/';
%output_dir = '/data/Collaborations/Karpen/Master_Joel/Joel/Screen/plates_imaged_on_sylvains_scope/';
output_dir = '/mnt/orona/ShareWithGenuser/Joel-live-test-12-15-12/';
...
blurr_rad = 150c; % the larger, the milder the background correction.  normally 30.  for cytospin 90. for live HP1a 150
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
search_str = '*';
...
chan1 = 1; %for campus 3 is ph2av, 2 is hp1a....for Sylvain's scope it is the opposite
chan2 = 1;  % To make sure R analysis is labelled properly set chan1 to be pH2Av and chan2 to be HP1a
