...
output_dir = '/data/Collaborations/Karpen/Master_Joel/Joel/glass_bottom_test/';
%%%%%%%%%%%%%%%%%%%%
file_ext = 'zvi'; % CHANGE HERE FOR DIFFERENT EXTENSION (e.g 'dv' = .dv, 'tif' = .tif)
...
for i_t=1:num_t % Open directory for time point i_t
    ...
    for i_img = 1:num_img % Read image i_img for time point i_t
        ...
        msNuc = measure(nuc_mask, temp{nuc_chan},'mean');
        for i_nuc = 1:num_nuc
