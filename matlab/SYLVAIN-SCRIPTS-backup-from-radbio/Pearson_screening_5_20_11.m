...
%
%Main directory
target_dir = '/mnt/orona/SERAFIN/1Z/';
output_dir = '/data/Collaborations/Karpen/Master_Joel/Joel/Serafin_12_11/';
%%%%%%%%%%%%%%%%%%%%
...
manual_threshold = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
seg_save_dir = [output_dir 'pearson_nuc_seg_saved_serafin/'];
mkdir(seg_save_dir);
search_str = '*';
...
for i_t=1:num_t % Open directory for time point i_t
    list_img = dir([target_dir list_name{i_t} '/*.' file_ext]);  % This (with '/*_w1_*.' will only work on images from the screening center or if I have '_w1_' in the name: noted by Joel
