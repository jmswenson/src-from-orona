...
target_dir = '/mnt/orona/jswenson/7-21-14_triton-extraction_RNAi-of-CG8108/';
output_dir = '/mnt/orona/jswenson/7-21-14_triton-extraction_RNAi-of-CG8108/matlab/';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
search_str = '*deconvolved*';
%search_str = '*';
%list_dir = dir([search_str]);  % 7-7-14 modified to read files in the target directory - Joel
list_dir = dir([target_dir search_str]);
nuc_chan = 4; %for screen nuc_chan =1....for InCell6000 nuc_chan=2 and chan2 is mCherry-HP1a, chan1 is GFP-ORF
