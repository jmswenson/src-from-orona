...
wait(100);
call("trainableSegmentation.Weka_Segmentation.loadClassifier", "/mnt/orona/jswenson/6-10-13-transient-HP1a-mutant-test-Mirus/test2-complex-classifier.model");
call("trainableSegmentation.Weka_Segmentation.loadData", "/mnt/orona/jswenson/6-10-13-transient-HP1a-mutant-test-Mirus/test2-complex-data.arff");
wait(10000);
