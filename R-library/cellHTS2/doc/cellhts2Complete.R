...
###################################################
### code chunk number 16: cellhts2Complete.Rnw:572-573
###################################################
table(wellAnno(x))
...
###################################################
### code chunk number 49: filterGeneset
###################################################
scores <- as.vector(Data(xsc))
...
###################################################
### code chunk number 50: gseamodule
###################################################
...
###################################################
### code chunk number 51: rewriteReport (eval = FALSE)
###################################################
...
###################################################
### code chunk number 52: load file with previous analysis
###################################################
...
###################################################
### code chunk number 53: add the current scored values
###################################################
...
###################################################
### code chunk number 54: scoresComparison
###################################################
...
###################################################
### code chunk number 55: example for description file
###################################################
...
###################################################
### code chunk number 56: old plateConfscreenLogTable
###################################################
...
###################################################
### code chunk number 57: Z score method (eval = FALSE)
###################################################
...
###################################################
### code chunk number 58: transfplots
###################################################
library("vsn")
...
###################################################
### code chunk number 59: transfplotsShow (eval = FALSE)
###################################################
## library("vsn")
## par(mfcol=c(3,2))
## myPlots=function(z,...) 
