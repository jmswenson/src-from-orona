...
###################################################
### code chunk number 2: tab-psi-functions
###################################################
...
###################################################
### code chunk number 3: fig-psi-functions
###################################################
...
###################################################
### code chunk number 4: lmrob_simulation.Rnw:297-317
###################################################
...
###################################################
### code chunk number 5: fig-example-design
###################################################
...
###################################################
### code chunk number 6: lmrob_simulation.Rnw:381-385
###################################################
...
###################################################
### code chunk number 7: simulation-run (eval = FALSE)
###################################################
...
###################################################
### code chunk number 8: lmrob_simulation.Rnw:425-426
###################################################
str(estlist, 1)
...
###################################################
### code chunk number 10: lmrob_simulation.Rnw:438-440 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 11: lmrob_simulation.Rnw:451-452
###################################################
str(estlist$output[1:3], 2)


###################################################
### code chunk number 12: simulation-aggr (eval = FALSE)
###################################################
## if (!file.exists(aggrResultsFile)) {
...
###################################################
### code chunk number 13: simulation-aggr2
###################################################
...
###################################################
### code chunk number 14: fig-meanscale
###################################################
...
###################################################
### code chunk number 15: fig-sdscale-1
###################################################
...
###################################################
### code chunk number 16: fig-sdscale-all
###################################################
...
###################################################
### code chunk number 17: fig-qscale
###################################################
...
###################################################
### code chunk number 18: fig-Mscale
###################################################
print(ggplot(droplevels(subset(test.3, Estimator %in% c("SMD", "MMqE"))),
...
###################################################
### code chunk number 19: fig-qscale-all
###################################################
...
###################################################
### code chunk number 20: fig-Mscale-all
###################################################
print(ggplot(droplevels(subset(test.1, Estimator %in% c("SMD", "MMqE") &
                                Psi == 'bisquare')),
             aes(p/n, M/q, color = Est.Scale)) +
...
###################################################
### code chunk number 21: fig-efficiency
###################################################
...
###################################################
### code chunk number 22: fig-efficiency-all
###################################################
...
###################################################
### code chunk number 23: fig-AdB2-1
###################################################
...
###################################################
### code chunk number 24: fig-sdAdB2-1
###################################################
...
###################################################
### code chunk number 25: fig-emp-level
###################################################
...
###################################################
### code chunk number 26: fig-lqq-level
###################################################
...
###################################################
### code chunk number 27: fig-power-1-0_2
###################################################
...
###################################################
### code chunk number 28: fig-power-1-0_4
###################################################
print(ggplot(subset(test.1, n == 25),
...
###################################################
### code chunk number 29: fig-power-1-0_6
###################################################
print(ggplot(subset(test.1, n == 25),
...
###################################################
### code chunk number 30: fig-power-1-0_8
###################################################
print(ggplot(subset(test.1, n == 25),
...
###################################################
### code chunk number 31: fig-power-1-1
###################################################
print(ggplot(subset(test.1, n == 25),
...
###################################################
### code chunk number 32: fig-pred-points
###################################################
...
###################################################
### code chunk number 34: lmrob_simulation.Rnw:1365-1420
###################################################
## Henning (1994) eq 33:
...
###################################################
### code chunk number 35: fig-max-asymptotic-bias
###################################################
