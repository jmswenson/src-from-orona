...
###################################################
### code chunk number 58: Layoutdemo
###################################################
# library(Rgraphviz)
plot(coex, "neato")
...
###################################################
### code chunk number 59: figneato
###################################################
z <- plot(coex, "neato")


###################################################
### code chunk number 60: Layoutdemo2 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 61: Layoutdemo3 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 62: figlayout1 (eval = FALSE)
###################################################
## crudeGraphPlot(coex)


###################################################
### code chunk number 63: figlayout2 (eval = FALSE)
###################################################
## crudeGraphPlot(coex, alg=kamadaKawaiSpringLayout, col="green")


###################################################
### code chunk number 64: Isomorphismdemo
###################################################
...
###################################################
### code chunk number 65: figcoex2i
###################################################
z <- plot(coex2i)


###################################################
### code chunk number 66: VertexColoringdemo
###################################################
sequential.vertex.coloring(coex)


###################################################
### code chunk number 67: transClosuredemo
###################################################
dijk.tc = transitive.closure(dijk)


###################################################
### code chunk number 68: figdijkTC
###################################################
  plot(dijk.tc, main="b) Transitive closure")


###################################################
### code chunk number 69: wavefrontdemo
###################################################
ss <- 1
...
###################################################
### code chunk number 70: Centralitydemo
###################################################
...
###################################################
### code chunk number 71: mincutdemo
###################################################
minCut(coex)


###################################################
### code chunk number 72: highlyConnSGdemo
###################################################
highlyConnSG(coex)
highlyConnSG(hcs)
...
###################################################
### code chunk number 73: MaxCliquedemo
###################################################
maxClique(coex)
maxClique(hcs)
...
###################################################
### code chunk number 74: IsTriangulateddemo
###################################################
...
###################################################
### code chunk number 75: Separatesdemo
###################################################
separates("B", "A", "E", km)
separates("B", "A", "C", km)
...
###################################################
### code chunk number 76: kCoresdemo1
###################################################
kCores(kcoex)
kcoex2 <- coex2
kCores(kcoex2)
...
###################################################
### code chunk number 77: figkcores
###################################################
z <- plot(kcoex)


###################################################
### code chunk number 78: kCliquesdemo
###################################################
kCliques(kclex)


###################################################
### code chunk number 79: figkcliques
###################################################
z <- plot(kclex)
